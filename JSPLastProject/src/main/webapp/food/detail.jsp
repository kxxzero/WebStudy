  ...
  <main class="container clear"> 
     ...
     <tr>
       <td width=40% class="text-center" rowspan="8">
        <img style="width:260px; height:350px" id="poster" src="${vo.poster}">
       </td>
       
       <td colspan="2">
        <h3 id="name">${vo.name}&nbsp;<span="color:orange">${vo.score}</span></h3>
       </td>
     </tr>
     ...
     <tr>
       <td colspan="3" id="" class="text-right">
       	<a href="#" class="btn bnt-xs btn-danger">좋아요(0)</a>
       	<a href="#" class="btn bnt-xs btn-success">찜하기</a>
       	<a href="#" class="btn bnt-xs btn-info">예약하기</a>
       	<a href="javascript:history.back()" class="btn bnt-xs btn-info">목록</a>
       </td>
     </tr>
    </table>
